	...
	static String[] maschGeber()
		{
			...
			csvFeld[3] = "567;900;Drehbank;Schloﬂerei";
			csvFeld[4] = "999;1000;Schweiﬂger‰t;Schloﬂerei";
			...
			csvFeld[10] = "454567;1600;Drehbank;Schloﬂerei";
			csvFeld[11] = "9;1300;Schweiﬂger‰t;Schloﬂerei";
			csvFeld[12] = "876;800;Fluxkompensator;Pausenraum";
			csvFeld[13] = "5676;100;Drehbank;Schloﬂerei";
			csvFeld[14] = "989;400;Schweiﬂger‰t;Schloﬂerei";
			csvFeld[15] = "376;600;Lˆtstation;Labor";
	...
	public static void main(String[] args) throws IOException
		{
			...
			// (S2) Schritt 2 
			System.out.println(
					"Maschinen Instanzen f¸r die CSV Strings aus maschGeber().\nPr¸fung und entsprechende Ausgabe\n\n\n");
			String[] csvF = maschGeber(); // CSV Strings aus maschGeber in ein Array laden
			List<Maschine> maschinenListe = new LinkedList<Maschine>(); // Liste f¸r korrekte Maschinen Instanzen
			...
			do
				{
					...
					switch (choice)
						...
						case 1:
							...
							System.out.println("Der Abschreibungswert der Maschine betr‰gt: "
